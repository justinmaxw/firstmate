...
The deferred bootstrap sweep re-converges that set except for session-scoped `config/trace-context`, whose current-home decision stays frozen until the next launch.
