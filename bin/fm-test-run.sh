...
family_for_basename() {
  case "$1" in
    ...
    fm-spec.test.sh|fm-metrics.test.sh|\
    ...
    fm-quota-array-dispatch-live-e2e.test.sh|fm-secondmate-compact-live-e2e.test.sh|\
    ...
    fm-spawn-agy-credential-preflight.test.sh|fm-spawn-agy-model-allowlist.test.sh|\
