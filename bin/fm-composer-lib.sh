...
# limitation recorded for it in the agy harness reference), so without this
# token the submit cores could never acknowledge a delivered agy Enter and
# would report an unsubmitted send that actually landed.
