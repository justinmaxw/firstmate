...
#                       (legacy PR-check migration, dead-record tidy, secondmate
#                       convergence, secondmate liveness, pending remote handoff
#                       retry, X-mode artifact writes, fleet sync) also run only
#                       when locked; the four network sweeps run in the deferred
