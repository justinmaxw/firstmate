...
test_gemini_does_not_claim_inherited_ai_agent() {
  ...
  out=$(env -u GEMINI_CLI -u CLAUDECODE -u CURSOR_AGENT -u CURSOR_INVOKED_AS \
        -u PI_CODING_AGENT -u GROK_AGENT -u ANTIGRAVITY_AGENT AI_AGENT=gemini-cli_0-58-0_agent "$HARNESS")
  [ "$out" != gemini ] \
  ...
  out=$(env -u CLAUDECODE -u CURSOR_AGENT -u CURSOR_INVOKED_AS -u GEMINI_CLI \
        -u PI_CODING_AGENT -u GROK_AGENT -u ANTIGRAVITY_AGENT GEMINI_CLI=0 "$HARNESS")
  [ "$out" != gemini ] \
...
SH
  chmod +x "$fakebin/ps"
  out=$(env -u GEMINI_CLI -u CLAUDECODE -u CURSOR_AGENT -u CURSOR_INVOKED_AS \
        -u PI_CODING_AGENT -u GROK_AGENT -u ANTIGRAVITY_AGENT PATH="$fakebin:$PATH" "$HARNESS")
  [ "$out" = gemini ] \
...
SH
  ...
  out=$(env -u GEMINI_CLI -u CLAUDECODE -u CURSOR_AGENT -u CURSOR_INVOKED_AS \
        -u PI_CODING_AGENT -u GROK_AGENT -u ANTIGRAVITY_AGENT FAKE_PS_COMM=gemini-helper \
  ...
  out=$(env -u GEMINI_CLI -u CLAUDECODE -u CURSOR_AGENT -u CURSOR_INVOKED_AS \
        -u PI_CODING_AGENT -u GROK_AGENT -u ANTIGRAVITY_AGENT FAKE_PS_COMM=node \
...
for (const k of ['GEMINI_CLI', 'CLAUDECODE', 'CURSOR_AGENT', 'CURSOR_INVOKED_AS',
                 'PI_CODING_AGENT', 'GROK_AGENT', 'ANTIGRAVITY_AGENT']) delete env[k];
